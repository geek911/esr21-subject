...
class AppConfig(DjangoAppConfig):
    ...
    form_versions = {
        ...
        'esr21_subject.adverseevent': 1.2,
        'esr21_subject.concomitantmedication': 1.3,
        'esr21_subject.covid19preventativebehaviours': 1.2,
        'esr21_subject.covid19symptomaticinfections': 1.2,
        'esr21_subject.demographicsdata': 1.3,
        'esr21_subject.eligibilityconfirmation': 1.2,
        'esr21_subject.hospitalisation': 1.3,
        'esr21_subject.informedconsent': 1.2,
        'esr21_subject.medicaldiagnosis': 1.1,
        'esr21_subject.medicalhistory': 1.2,
        'esr21_subject.personalcontactinfo': 1.2,
        'esr21_subject.physicalexam': 1.3,
        ...
        'esr21_subject.seriousadverseevent': 1.2,
        'esr21_subject.specialinterestadverseevent': 1.2,
        'esr21_subject.subjectrequisition': 1.2,
        'esr21_subject.subjectvisit': 1.1,
        'esr21_subject.targetedphysicalexamination': 1.2,
        'esr21_subject.vaccinationdetails': 1.3,
        'esr21_subject.vitalsigns': 1.2,
        }
