...
class AppConfig(DjangoAppConfig):
    ...
    form_versions = {
        ...
        'esr21_subject.informedconsent': 2.0,
        'esr21_subject.medicaldiagnosis': 2.0,
        'esr21_subject.medicalhistory': 2.0,
        'esr21_subject.personalcontactinfo': 2.0,
        'esr21_subject.physicalexam': 2.0,
        'esr21_subject.pregnancystatus': 2.0,
        'esr21_subject.pregnancytest': 2.0,
        'esr21_subject.rapidhivtesting': 2.0,
