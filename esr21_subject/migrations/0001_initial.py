# Generated by Django 3.1.4 on 2021-09-13 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'unique_together': {('first_name', 'dob', 'initials', 'version'), ('subject_identifier', 'screening_identifier', 'version'), ('subject_identifier', 'version')},
            },
            managers=[
                ('objects', django.db.models.manager.Manager()),
                ('on_site', edc_base.sites.managers.CurrentSiteManager()),
