# Generated by Django 3.1.4 on 2021-09-05 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Name of the Adverse Event')),
                ...
                ('start_date', models.DateField(blank=True, null=True, validators=[edc_protocol.validators.date_not_before_study_start, edc_base.model_validators.date.date_not_future], verbose_name='Adverse Event start date')),
                ...
                ('substance_hypersensitivity', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], help_text='Hypersensitivity to the active substance or to any of the excipients', max_length=30, null=True, verbose_name='Is participant hypersensitivity to any substance?')),
                ('status', models.CharField(blank=True, choices=[('resolved', 'Resolved'), ('ongoing', 'Ongoing'), ('death', 'Death')], max_length=10, null=True, verbose_name='Status of the Adverse Event')),
                ('ae_grade', models.CharField(blank=True, choices=[('mild', 'Mild (Grade 1)'), ('moderate', 'Moderate (Grade 2)'), ('severe', 'Severe (Grade 3)'), ('life_threatening', 'Life-threatening (Grade 4)'), ('fatal', 'Fatal (Grade 5)')], max_length=30, null=True, verbose_name='FDA Severity Grading')),
                ('study_treatmnt_rel', models.CharField(blank=True, choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to study treatment')),
                ('nonstudy_treatmnt_rel', models.CharField(blank=True, choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to non-study treatment')),
                ('studyproc_treatmnt_rel', models.CharField(blank=True, choices=[('related', 'Related'), ('not_related', 'Not Related')], max_length=15, null=True, verbose_name='Relationship to study procedure')),
                ('action_taken', models.CharField(blank=True, choices=[('dose_not_changed', 'Dose not changed'), ('drug_withdrawal', 'Drug withdrawal'), ('N/A', 'N/A'), ('unknown', 'unknown')], max_length=50, null=True, verbose_name='Action taken with study treatment')),
                ...
                ('serious_event', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was this considered to be a Serious Adverse Event?')),
                ('special_interest_ae', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], help_text='(If Yes, check all serious criteria that apply on the corresponding SAE form.)', max_length=3, null=True, verbose_name='Was the event an AE of Special Interest?')),
                ('medically_attended_ae', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was the event a Medically attended AE?')),
                ...
                ('treatment_given', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Was treatment given?')),
                ...
                ('ae_study_discontinued', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Did the AE cause the subject to discontinue from the study?')),
                ('discontn_dt', models.DateField(blank=True, null=True, verbose_name='Date of discontinuation')),
                ('covid_related_ae', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, verbose_name='Is this a COVID-19 related AE?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('systolic_bp', models.IntegerField(blank=True, help_text='Fixed Unit: mmHg', null=True, validators=[django.core.validators.MinValueValidator(75), django.core.validators.MaxValueValidator(220)], verbose_name='Systolic Blood Pressure')),
                ('diastolic_bp', models.IntegerField(blank=True, help_text='Fixed Unit: mmHg', null=True, validators=[django.core.validators.MinValueValidator(55), django.core.validators.MaxValueValidator(150)], verbose_name='Diastolic Blood Pressure')),
                ('heart_rate', models.IntegerField(blank=True, help_text='beats/min', null=True, verbose_name='Heart Rate')),
                ('body_temp', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Body Temperature')),
                ...
                ('oxygen_saturated', models.DecimalField(blank=True, decimal_places=2, help_text='Fixed Unit: %', max_digits=5, null=True, verbose_name='Oxygen Saturation (via Pulse Oximetry)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meddra_pname', models.CharField(max_length=100, verbose_name='MedDRA Preferred Name of the SAE')),
                ('meddra_pcode', models.CharField(max_length=50, verbose_name='MedDRA Preferred Code OF the SAE')),
                ('meddra_version', models.IntegerField(verbose_name='MedDRA version')),
                ...
                ('event_abate', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Did the event abate after drug discontinuation?')),
                ...
                ('adverse_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='esr21_subject.adverseevent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant_weight', models.DecimalField(decimal_places=3, max_digits=5, verbose_name='Participant Weight')),
                ('participant_height', models.DecimalField(decimal_places=3, max_digits=5, verbose_name='Participant Height')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_count', models.IntegerField(blank=True, help_text='Number of tubes, samples, etc being sent for this test/order only. Determines number of labels to print', null=True, verbose_name='Total number of items')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meddra_pname', models.CharField(max_length=100, verbose_name='MedDRA Preferred Name of the AESI')),
                ('meddra_pcode', models.CharField(max_length=50, verbose_name='MedDRA Preferred Code of the AESI')),
                ('meddra_version', models.IntegerField(verbose_name='MedDRA version')),
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(primary_key=True, serialize=False)),
                ('adverse_event', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='esr21_subject.adverseevent')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('any_vaccine_receipt', models.CharField(blank=True, help_text='For study participants who become hospitalised with COVID-19, receipt of licensed treatment options and/or participation in investigational treatment studies is permitted.', max_length=50, null=True, verbose_name='Any receipt of, or planned receipt of any vaccines, medications, or investigational products indicated for the prevention of SARS-CoV-2 infection or treatment of COVID-19?')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('adverse_event', 'start_date', 'end_date', 'aesi_category')},
            },
        ),
        migrations.CreateModel(
            name='OnScheduleIll',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'unique_together': {('subject_identifier', 'screening_identifier', 'version'), ('first_name', 'dob', 'initials', 'version'), ('subject_identifier', 'version')},
            },
            managers=[
                ('objects', django.db.models.manager.Manager()),
                ('on_site', edc_base.sites.managers.CurrentSiteManager()),
