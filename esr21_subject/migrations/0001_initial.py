# Generated by Django 3.1.4 on 2021-09-10 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.", validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date and Time')),
                ('current_hiv_status', models.CharField(choices=[('POS', 'Positive'), ('NEG', 'Negative'), ('IND', 'Indeterminate')], help_text='if POS or NEG, ask for documentation.', max_length=30, verbose_name='What is your current HIV status?')),
                ('evidence_hiv_status', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='evidence = clinic and/or IDCC records. check regimes/drugs. If NO, more criteria required.', max_length=15, null=True, verbose_name='(Interviewer) Have you seen evidence of the HIV result?')),
                ('week32_test', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=3, verbose_name='Have you tested for HIV before?')),
